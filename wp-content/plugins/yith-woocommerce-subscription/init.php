...
if ( defined( 'YITH_YWSBS_VERSION' ) ) {
	...
	define( 'YITH_YWSBS_VERSION', '2.19.0' );
}
...
function yith_ywsbs_constructor() {
	...
	if ( ! function_exists( 'WC' ) ) {
		/**
		 * Check if WooCommerce in installed.
		 */
		function yith_ywsbs_install_woocommerce_admin_notice() {
			?>
			<div class="error">
	...
	require_once YITH_YWSBS_INC . 'class.ywsbs-subscription-shortcodes.php';
	...
	require_once YITH_YWSBS_INC . 'class.yith-wc-subscription-frontend.php';
	require_once YITH_YWSBS_INC . 'class.ywsbs-subscription-my-account.php';
	require_once YITH_YWSBS_INC . 'class.yith-wc-subscription-limit.php';
	require_once YITH_YWSBS_INC . 'class.ywsbs-subscription-user.php';
	require_once YITH_YWSBS_INC . 'functions.yith-wc-subscription-product.php';
	...
	require_once YITH_YWSBS_INC . 'admin/class.ywsbs-subscription-post-type-admin.php';
	require_once YITH_YWSBS_INC . 'admin/class.ywsbs-product-post-type-admin.php';
