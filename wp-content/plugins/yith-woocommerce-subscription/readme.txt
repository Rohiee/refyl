...
2. Plugin options
3. View subscriptions in your WooCommerce shop page
4. View subscriptions in WooCommerce single product page
5. Cart page
6. Checkout page
7. Subscription list on "My Account" page
8. Subscription detail on "My Account" page
9. Product editor
