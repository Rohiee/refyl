	...
	function hyori_custom_styles() {
		...
		?>
			...
			<?php if ( hyori_get_config('button_color') != "" ) : ?>
				...
				.product-block.grid .add-cart a.button, .product-block.grid .add-cart a.added_to_cart {
					background-image: linear-gradient(to right, <?php echo esc_html( hyori_get_config('main_color') ) ?>, <?php echo esc_html( hyori_get_config('text_color') ) ?>, #ffaa00);
				}
			<?php endif; ?>
			<?php if ( hyori_get_config('button_hover_color') != "" ) : ?>
				...
				.product-block.grid .add-cart a.button:hover, .product-block.grid .add-cart a.added_to_cart:hover {
					background-image: linear-gradient(to right, <?php echo esc_html( hyori_get_config('text_color') ) ?>, <?php echo esc_html( hyori_get_config('main_color') ) ?>, #ffaa00);
				}
			<?php endif; ?>
	<?php
