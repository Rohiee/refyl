        ...
        <?php if ( hyori_get_config('show_vertical_menu') && has_nav_menu( 'vertical-menu' ) ): ?>
            <div class="row">
                <div class="bottom-mobile clearfix">
                    <div class="col-xs-12">
                        <h4 class="text-title mobile-vertical-menu-title"><span><?php echo esc_html__('All Categories','hyori') ?></span><i aria-hidden="true" class="fa fa-angle-down pull-right"></i></h4>
                    </div>
                </div>
            </div>
        <?php endif; ?>
